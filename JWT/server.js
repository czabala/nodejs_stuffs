...
*/
    ...
    const payload = {
      admin: true,
	  user: "this_user",
	  lala: "this is a simple text"
    };
	
    console.log('Went here...');
       /* var token = jwt.sign(payload, app.get('superSecret'), {
          expiresInMinutes: 1440 // expires in 5 minutes
        });*/
		
  //      var token = jwt.sign(payload, app.get('superSecret'), {expiresIn:120});
		var token = jwt.sign(payload, app.get('superSecret'), {});
...
// route to validate a user (POST http://localhost:8080/api/validate)
